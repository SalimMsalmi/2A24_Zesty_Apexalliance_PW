...
/*-require '../../../controller/produitC.php';------------------------Produit.php----------------------------*/
           ...
           while ($row = $result->fetch_assoc()): ?>
               ...
               <tr>
                ...
                <td   ><img style="width:52px; 
                  height:52px"  src="../../front/img/maquillage/<?php echo $row["image"]; ?>" alt=""></td>
                <td> <a  href="products.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">Edit </a>
                  <a href="products.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete </a></td>
                </tr>
                <?PHP
        endwhile;
?>
