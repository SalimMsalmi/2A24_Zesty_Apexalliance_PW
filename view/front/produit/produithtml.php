        ...
        <div class="row product-list">
          ...
          <section class="panel">
             <div class="pro-img-box">
                <img class="shop-img"src="../../front/img/maquillage/<?php echo $row["image"]; ?>"" alt="" />
                <button  class="adtocart fa fa-shopping-cart ">
                </button>
              </div>
...
?>
      ...
      <div class="cart-row">
        ...
        <span class="cart-item cart-header cart-column">TYPE</span>
      ...
      <button style="margin-right:10px;"class="btn btn-primary btn-purchase" type="button">
        PURCHASE
      </button>
    </section>
