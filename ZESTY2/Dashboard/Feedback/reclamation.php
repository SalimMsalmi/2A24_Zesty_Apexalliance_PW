...
<div class="container my-5">
  <form method="post" id="myform">
     ...
     <span style="color:red" id="cmon"></span>
     </div>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" 
     placeholder="Enter your Specification" autocomplete="off" name="Specification" required>
    
 </div>
 <div class="form-group">
    <label>Description</label>
    <input type="text" class="form-control" 
     placeholder="Enter your Description" autocomplete="off"  name="Description" required>
 </div>
