<?php
$con=new mysqli('localhost','root','','zesty');
...
<div class="elements">
  ...
  <tbody>
    ...
    <button class="add-rec-btn"><a style="text-decoration:none"href="reclamation.php"
         class="text-light">ADD Complaint</a>
         </button>
         <button style="margin-left:1148px"class="add-rec-btn"><a style="text-decoration:none"href="bergila/index.php"
         class="text-light">Online Chatroom</a>
         </button>
    </div>
</div>
