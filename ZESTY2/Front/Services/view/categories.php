...
/////////////categories 
$conn= mysqli_connect('localhost', 'root', '', 'zesty');
...
.content .field-modif{
  ...
  justify-content: center;
	...
	<div class="menu">
		<ul class="ul">
            <a><li class="li" style="color:black;">home</li></a>
        ...
        <div class="page-header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                    <a href="../../Login/Users/Landing/Landing.php">Home</a>
                        <a href="service.php">Services & Appointements</a>
                    </div>
                </div>
            </div>
        </div>
