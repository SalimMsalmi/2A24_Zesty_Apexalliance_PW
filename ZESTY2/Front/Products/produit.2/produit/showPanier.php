   ...
   {    $S=(intval($row['prix'])*intval($row['qte']));
        ...
        ?>                <tbody >
                  <div class="cart-items"> 
                      <tr valign="middle">
                                  ...
                                  <td valign="middle">
                                  <img width="200px" src="../../img/produits/<?php echo $row['imgproduit'];?> "></center></td>
                                    <th>
                                    <h5 style="position: relative;top: 50px;color:white;"><?php echo $row['nomproduit'];?></h5></center></th>


                                  <td style="margin: auto"><center><h5 class="cart-price"style="position: relative;top: 50px;color:white;"><?php echo $row['prix'];?> TND</h5></center></td>
    ...
    <option value="1"   <?php if ($row['qte']==1) echo "selected" ; ?>>1</option>
       ...
       <option value="7"  <?php if ($row['qte']==7) echo "selected" ; ?>>7</option>
                      ...
                      <td><center><h5 style="position: relative;top: 50px;color:white;"><?php echo $S.' '.'TND' ; ?></h5></center></td>
      ...
      <button class="btn btn-danger" value="supprimer" name="supprimer" type="submit"><i class="fa fa-trash-o" aria-hidden="true">Supprimer</i></button>
        ...
        <?php
            ...
            <h3 style="color:white;"><?php echo 'Total:'.'    '.'  '. $S1.' '.'TND';?></h3>
