  ...
  height: 50px;"class="img-thumbnail" src="../../img/zesty.png" alt=""></a> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="../../../Login/Users/Landing/Landing.php">Home</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="../../../News/view/Newsfront.php">Blog</a></li>
