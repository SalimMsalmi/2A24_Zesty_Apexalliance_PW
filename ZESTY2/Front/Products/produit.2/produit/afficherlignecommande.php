...
$l=0;
 ...
 ?>    
        ...
        <tr valign="middle">
            ...
            <td align="center"style ="color:white;"><?php echo $row["id_commande"]?></td>
            <td align="center"style ="color:white;"><?php echo $row["prix_tot"].' '.'TND' ?></td>
            <td align="center"style ="color:white;"><?php echo $row["etat"]?></td>
