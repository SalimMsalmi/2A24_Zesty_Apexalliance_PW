...
<div class="intro">
        ...
        <form id="myform" method="POST"enctype="multipart/form-data">
            ...
            <div class="corps-formulaire">
              <div class="gauche">
                <div class="groupe">
                  <input id="name" name="name" type="text" autocomplete="off" value="<?php echo $user['id']?>" style="display:none;" />
                  <span id="cmon"></span>
                </div>
                <div class="groupe">
                  <label>Date</label>
                  <input style="display:none" name="date" type="date" id="dd" />
                </div>
              </div>
              <div class="droite">
                <div class="groupe">
...
<script>
   ...
   document.forms["signup"].addEventListener("submit",function (e){
    ...
    var date_naissance=yyyy+"-"+mm+"-"+dd;
    console.log(date_naissance);
    document.getElementById("dd").value=date_naissance;
    </script>
<style>
