<?php
	...
	$listecommentaire=$commentaire->affichercommentairetri($_GET["id"]); 
?>
<?php
...
<div class="intro">
      ...
      <a href="supprimercommentaire.php?id=<?php echo $commentaire['idcom']; ?>" class="readmore" style="margin-left: 500px;">Delete</a>
		<h1 class="entry-title"><?php echo $commentaire['Datecom']; ?></h1>
        	...
        	<a href="addcommentairefront.php?d" class="readmore">Add Comment</a>
			<a href="commentairefront.php"class="readmore" style="margin-left:500px;margin-top:300px;" >Sort</a>
